...
\begin{document}
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node (foss data) at (foss.south) [below, text width = \paperwidth-\cvMiddleSidebar-\Margin] {
      \begin{cvtext}
        \project{szymonmaszke/torchlayers}{https://github.com/szymonmaszke/torchlayers}{\input{data/torchlayers.txt}}{03.2020}
        ...
        \project{szymonmaszke/torchlambda}{https://github.com/szymonmaszke/torchlambda}{\input{data/torchlambda.txt}}{03.2020}
        {Lightweight deployment of PyTorch neural networks to AWS Lambda}
        {Reduced fixed costs of AI infrastructure (1M free requests)}

        \fossrulefill

        \project{szymonmaszke/torchdata}{https://github.com/szymonmaszke/torchdata}{\input{data/torchdata.txt}}{09.2019}
        ...
        \project{szymonmaszke/torchfunc}{https://github.com/szymonmaszke/torchfunc}{\input{data/torchfunc.txt}}{09.2019}
        {PyTorch functions and utilities to make your life easier}
        {\faTrophy\space One of \href{https://devpost.com/software/torch-torchdata-torchfunc}{PyTorch Global Summer Hackathon 2019} winning projects}

        \fossrulefill

        \project{szymonmaszke/vimpyter}{https://github.com/szymonmaszke/vimpyter}{\input{data/vimpyter.txt}}{03.2018}

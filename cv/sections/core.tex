...
\begin{document}
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node (work data) at (work.south) [below, text width = \paperwidth-\cvMiddleSidebar-\Margin] {
      \begin{cvtext}
        \work{Head of content}{\href{https://www.theaicore.com/}{AiCore}}{11/2020}{Present}
        {
          {
            Developed ML/DL/Deployment units of the course,
            Taught Python/DS/ML/DL/Deployment to students (100+ people),
            Ran mock interviews and supported students' projects/development
          }
        }
    ...
    \node (foss) at ($(work data.south)+(0cm, 2.89mm)$)
      ...
      minimum width=\paperwidth-\cvMiddleSidebar, minimum height=\cvSectionHeight]
      {\Large \textbf{\textcolor{background}{\faHeart\space Open Source}}};

...
\begin{document}
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \sidebarEnum{github}{$(current page.north west)+(\cvMiddleSidebar / 2,\textStart)+(0cm,-1.4\Margin)$}
      ...
      {
        {
          \faStar/\textbf{\input{cv/data/stars.txt}}stars received,
          \faPlus/\textbf{\input{cv/data/contributions.txt}}contributions,
          \faUser/\textbf{\input{cv/data/followers.txt}}followers,
        }
      }
    ...
    \sidebarEnum{stackoverflow}{$(github data.south)+(0cm, \Margin-2.8mm)$}
      ...
      {
        {
          \faStar/\input{cv/data/stack-special1.txt},
          \faTrophy/\input{cv/data/stack-special2.txt},
          \faCheck/\textbf{\input{cv/data/answers.txt}}answers,
          \faThumbsUp/\textbf{\input{cv/data/points.txt}}points,
          \faUser/\textbf{\input{cv/data/reached.txt}}reached,
        }
      }
